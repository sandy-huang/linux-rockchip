...
static const struct vop_ctrl rk3368_ctrl_data = {
	.standby = VOP_REG(RK3368_SYS_CTRL, 0x1, 22),
	.gate_en = VOP_REG(RK3368_SYS_CTRL, 0x1, 23),
	.rgb_en = VOP_REG(RK3368_SYS_CTRL, 0x1, 12),
	.hdmi_en = VOP_REG(RK3368_SYS_CTRL, 0x1, 13),
	.edp_en = VOP_REG(RK3368_SYS_CTRL, 0x1, 14),
	.mipi_en = VOP_REG(RK3368_SYS_CTRL, 0x1, 15),
	.dither_down = VOP_REG(RK3368_DSP_CTRL1, 0xf, 1),
	.dither_up = VOP_REG(RK3368_DSP_CTRL1, 0x1, 6),
	.data_blank = VOP_REG(RK3368_DSP_CTRL0, 0x1, 19),
	.out_mode = VOP_REG(RK3368_DSP_CTRL0, 0xf, 0),
	...
	.htotal_pw = VOP_REG(RK3368_DSP_HTOTAL_HS_END, 0x1fff1fff, 0),
	.hact_st_end = VOP_REG(RK3368_DSP_HACT_ST_END, 0x1fff1fff, 0),
	.vtotal_pw = VOP_REG(RK3368_DSP_VTOTAL_VS_END, 0x1fff1fff, 0),
	.vact_st_end = VOP_REG(RK3368_DSP_VACT_ST_END, 0x1fff1fff, 0),
	.hpost_st_end = VOP_REG(RK3368_POST_DSP_HACT_INFO, 0x1fff1fff, 0),
	.vpost_st_end = VOP_REG(RK3368_POST_DSP_VACT_INFO, 0x1fff1fff, 0),
	.line_flag_num[0] = VOP_REG(RK3368_LINE_FLAG, 0x1fff, 0),
	.line_flag_num[1] = VOP_REG(RK3368_LINE_FLAG, 0x1fff, 16),
	.cfg_done = VOP_REG_MASK(RK3368_REG_CFG_DONE, 0x1, 0),
};
...
static const struct vop_intr rk3368_vop_intr = {
	...
	.status = VOP_REG_MASK(RK3368_INTR_STATUS, 0xffff, 0),
	.enable = VOP_REG_MASK(RK3368_INTR_EN, 0xffff, 0),
	.clear = VOP_REG_MASK(RK3368_INTR_CLEAR, 0xffff, 0),
};

static const struct vop_reg_data rk3368_init_reg_table[] = {
	{RK3368_SYS_CTRL, 0x0000f800},
	{RK3368_DSP_CTRL0, 0x00000000},
	{RK3368_WIN0_CTRL0, 0x00000080},
	{RK3368_WIN1_CTRL0, 0x00000080},
	/* TODO: Win2/3 support multiple area function, but we haven't found
	 * a suitable way to use it yet, so let's just use them as other windows
	 * with only area 0 enabled.
	 */
	{RK3368_WIN2_CTRL0, 0x00000010},
	{RK3368_WIN3_CTRL0, 0x00000010},
};

static const struct vop_data rk3368_vop = {
	.init_table = rk3368_init_reg_table,
	.table_size = ARRAY_SIZE(rk3368_init_reg_table),
	.intr = &rk3368_vop_intr,
	.ctrl = &rk3368_ctrl_data,
	/*
	 * rk3368 vop windows register layout is same as rk3288.
	 */
	.win = rk3288_vop_win_data,
	.win_size = ARRAY_SIZE(rk3288_vop_win_data),
};
