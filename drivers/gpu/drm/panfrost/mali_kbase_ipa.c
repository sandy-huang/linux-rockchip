...
static DEVICE_ATTR(group0, 0644, show_ipa_group, set_ipa_group);
static DEVICE_ATTR(group1, 0644, show_ipa_group, set_ipa_group);
static DEVICE_ATTR(group2, 0644, show_ipa_group, set_ipa_group);
static DEVICE_ATTR(group3, 0644, show_ipa_group, set_ipa_group);
static DEVICE_ATTR(group4, 0644, show_ipa_group, set_ipa_group);
static DEVICE_ATTR(group5, 0644, show_ipa_group, set_ipa_group);
static DEVICE_ATTR(group6, 0644, show_ipa_group, set_ipa_group);
static DEVICE_ATTR(group7, 0644, show_ipa_group, set_ipa_group);
